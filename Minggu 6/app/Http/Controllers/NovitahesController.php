...
class NovitahesController extends Controller
{
    public function index(){
        //return "Halo ini adalah method index, dalam controller Novitahes";
        $nama = "Novita Hesti Wulansari";
        $pelajaran = ["Pemrograman Lanjut","MVC pada Laravel"];

        return view('novita', compact('nama', 'pelajaran'));
    }
